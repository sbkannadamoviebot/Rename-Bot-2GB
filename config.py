...
class Config(object):
    # pyro client config
    API_ID = os.environ.get("API_ID", "30451099")
    ...
    # database config
    DATABASE_NAME = os.environ.get("DATABASE_NAME","SBKANNADA")     
    DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://SBKANNADA:SBKANNADAMOVIEBOT@sbkannada.0qq1qjs.mongodb.net/?appName=SBKANNADA")

    # other configs
    BOT_UPTIME = time.time()
    START_PIC = (os.environ.get("START_PIC", "https://envs.sh/N2f.jpg https://envs.sh/N2a.jpg https://envs.sh/N2O.jpg")).split()
    ADMIN = int(os.environ.get("ADMIN", "5974804314"))

    # channels
    IS_FSUB = os.environ.get("IS_FSUB", "False").lower() == "true"  # Set "True" For Enable Force Subscribe
    AUTH_CHANNELS = list(map(int, os.environ.get("AUTH_CHANNELS", "-1003656942560").split())) # Add Multiple Channels iD By Space
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003644203182"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1003656942560"))
